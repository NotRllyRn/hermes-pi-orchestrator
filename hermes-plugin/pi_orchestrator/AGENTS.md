...
| `service.py` | Human-gated orchestration, parallel review/integration, and project projection policy. |
| `store.py` | SQLite project/task/decision/route/cursor/activity/notification state and migrations. |
